...
.rakes_details input[type=text], select {
  width: 100%;
  padding: 12px 20px;
  margin: 8px 0;
...
.rakes_details input[type=date], select {
  width: 100%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
...
.rakes_details input[type=submit] {
  width: 100%;
...
<h1>Rakes Details</h1>
<div class="rakes_form">
  <form class="rakes_details" action="Rakes.php">
    <label for="transfer_id">Transfer ID</label>
    <input type="text" id="transfer_id" name="transfer_id" placeholder="Enter GST No..">
    <label for="mode">Mode of Freight</label>
    <input type="text" id="mode" name="mode" placeholder="Enter Mode of Freight..">
    <label for="area">Area</label>
    <input type="text" id="area" name="area" placeholder="Enter Area of Dumps..">
    <label for="date_of_dispatch">Date of Dispatch</label>
    <input type="date" id="date_of_dispatch" name="date_of_dispatch" placeholder="Enter Date of Dispatch..">
